package
{
	import com.codeazur.libtess2_int.Tesselator;
	...
	public class StressTestSpriteInt extends Sprite
	{
		...
		public function StressTestSpriteInt()
		{
		...
		private function doStuff(e:Event):void
		{
			...
			var path1:Vector.<int> = createCircle(new Point(300, 300), 250, 50, 250);
			var path2:Vector.<int> = createCircle(new Point(300, 300), 190, 50, 150);
			var path3:Vector.<int> = createCircle(new Point(300, 300), 130, 50, 100);
			var path4:Vector.<int> = createCircle(new Point(300, 300), 50, 50, 100);
			...
			var vertices:Vector.<int> = t.getVertices();
			...
			tf.appendText("------\n" + total + " ms total " + "(" + nf.formatNumber(avgTotal) + " avg)\n" + "------\n" + errorCount + " errors");
		...
		private function createCircle(center:Point, radius:Number, noise:Number, count:uint, clockwise:Boolean = true):Vector.<int>
		{
